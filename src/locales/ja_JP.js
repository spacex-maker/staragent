export default {
  ...
  // 充值模态框
  'rechargeModal.title': 'アカウントチャージ',
  'rechargeModal.tab.recharge': 'チャージ',
  'rechargeModal.tab.history': '取引履歴',
  'rechargeModal.packages.title': 'パッケージを選択',
  'rechargeModal.package.monthly': '月額パッケージ',
  'rechargeModal.package.quarterly': '四半期パッケージ',
  'rechargeModal.package.yearly': '年間パッケージ',
  'rechargeModal.dailyLimit': '1日の割当量',
  'rechargeModal.period': '有効期間',
  'rechargeModal.feature.dailyTokens': '1日{tokens}トークン',
  'rechargeModal.feature.validPeriod': '{days}日間有効',
  'rechargeModal.feature.priority': 'リクエスト優先処理',
  'rechargeModal.feature.support': '標準サポート',
  'rechargeModal.feature.exclusive': '特別機能',
  'rechargeModal.customAmount.title': 'カスタムチャージ金額',
  'rechargeModal.customAmount.description': 'ニーズに合わせてチャージ金額をカスタマイズ。金額が多いほどボーナストークンが付与されます。',
  'rechargeModal.customAmount.placeholder': 'チャージ金額を入力',
  'rechargeModal.customAmount.switchToCustom': 'カスタム金額に切り替え',
  'rechargeModal.button.pay': '今すぐ支払う',
  'rechargeModal.message.packageSelected': '{package}を選択しました。お支払いページに移動します...',
  'rechargeModal.message.customAmount': '{amount}をチャージします。お支払いページに移動します...',
  'rechargeModal.message.selectRequired': 'パッケージを選択するか、チャージ金額を入力してください',
  'rechargeModal.table.time': '時間',
  'rechargeModal.table.type': 'タイプ',
  'rechargeModal.table.amount': '金額',
  'rechargeModal.table.currency': '通貨',
  'rechargeModal.table.balance': '変更後の残高',
  'rechargeModal.table.remark': '備考',
  'rechargeModal.table.transactionInfo': '取引情報',
  'rechargeModal.filter.allTypes': 'すべてのタイプ',
  'rechargeModal.filter.allCurrencies': 'すべての通貨',
  'rechargeModal.changeType.aiModelFee': 'AIモデル使用料',
  'rechargeModal.changeType.recharge': 'チャージ',
  'rechargeModal.error.fetchFailed': '取引履歴の取得に失敗しました',
  'rechargeModal.table.total': '件',
  'rechargeModal.table.empty': 'データなし',
  'userMenu.recharge': 'アカウントチャージ',
