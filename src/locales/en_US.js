export default {
  ...
  'aiAgentModal.form.maxTokens.required': 'Please enter the maximum token count',
  'aiAgentModal.form.maxTokens.min': 'Maximum token count must be greater than 0',
  'aiAgentModal.form.maxTokens.placeholder': 'Please enter the maximum token count',
  'aiAgentModal.form.status': 'Status',
  'aiAgentModal.form.status.required': 'Please select a status',
  'aiAgentModal.form.status.active': 'Active',
  'aiAgentModal.form.status.inactive': 'Inactive',

  // Gender related
  'aiAgentModal.form.gender': 'Gender',
  'aiAgentModal.form.gender.unknown': 'Unknown',
  'aiAgentModal.form.gender.male': 'Male',
  'aiAgentModal.form.gender.female': 'Female',
  ...
  // Recharge Modal
  'rechargeModal.title': 'Account Recharge',
  'rechargeModal.tab.recharge': 'Recharge',
  'rechargeModal.tab.history': 'Transaction Records',
  'rechargeModal.packages.title': 'Select Package',
  'rechargeModal.package.monthly': 'Monthly Package',
  'rechargeModal.package.quarterly': 'Quarterly Package',
  'rechargeModal.package.yearly': 'Yearly Package',
  'rechargeModal.dailyLimit': 'Daily Quota',
  'rechargeModal.period': 'Valid Period',
  'rechargeModal.feature.dailyTokens': '{tokens} Tokens Daily',
  'rechargeModal.feature.validPeriod': 'Valid for {days} days',
  'rechargeModal.feature.priority': 'Priority Request Processing',
  'rechargeModal.feature.support': 'Standard Support',
  'rechargeModal.feature.exclusive': 'Exclusive Features',
  'rechargeModal.customAmount.title': 'Custom Recharge Amount',
  'rechargeModal.customAmount.description': 'Customize recharge amount based on your needs. Higher amounts get bonus tokens.',
  'rechargeModal.customAmount.placeholder': 'Enter recharge amount',
  'rechargeModal.button.pay': 'Pay Now',
  'rechargeModal.message.packageSelected': 'You have selected {package}, redirecting to payment...',
  'rechargeModal.message.customAmount': 'You will recharge {amount}, redirecting to payment...',
  'rechargeModal.message.selectRequired': 'Please select a package or enter a recharge amount',
  'rechargeModal.customAmount.switchToCustom': 'Switch to custom amount',
  'rechargeModal.table.time': 'Time',
  'rechargeModal.table.type': 'Type',
  'rechargeModal.table.amount': 'Amount',
  'rechargeModal.table.currency': 'Currency',
  'rechargeModal.table.balance': 'Balance After Change',
  'rechargeModal.table.remark': 'Remark',
  'rechargeModal.table.transactionInfo': 'Transaction Info',
  'rechargeModal.filter.allTypes': 'All Types',
  'rechargeModal.filter.allCurrencies': 'All Currencies',
  'rechargeModal.changeType.aiModelFee': 'AI Model Usage Fee',
  'rechargeModal.changeType.recharge': 'Recharge',
  'rechargeModal.table.total': 'records',
  'rechargeModal.table.empty': 'No data',
  'rechargeModal.error.fetchFailed': 'Failed to fetch transaction records',
  'userMenu.recharge': 'Recharge',
